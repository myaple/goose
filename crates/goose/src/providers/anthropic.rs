...
// Removed std::time::Duration as timeout_secs is u64

use super::base::{ConfigKey, Provider, ProviderMetadata, ProviderUsage};
use super::errors::ProviderError;
use super::formats::anthropic::{create_request, get_usage, response_to_message};
use super::utils::{build_http_client_with_mtls, emit_debug_trace, get_model}; // Added build_http_client_with_mtls
...
impl AnthropicProvider {
    pub fn from_env(model: ModelConfig) -> Result<Self> {
        ...
        let timeout_secs: u64 = config.get_param("ANTHROPIC_TIMEOUT").unwrap_or(600);

        let client = build_http_client_with_mtls(&config, "ANTHROPIC", timeout_secs)?;
